...
#retrive the industry from user and find from collection
...
#retrive the sector from user and find from collection
...
#display the sector from user and find from collection
...
#retrive the company from user and find from collection
def select_by_company(industry):
    results = []
    cursor = collection.find( { "Company":  industry } )
    for record in cursor:
        results.append(record)
    return results
        
#retrive the max and min from user and find from collection        
...
#retrive the industry from user get symbols from collection
...
#retrive the tickers from user and find from collection        
...
#sorts documents by function
def sort_func(e):
    return e["50-Day Simple Moving Average"]
  
#sorts documents by industry
